...
- React/Vite frontend shell with SaaS-style navigation, core pages, registry promotion workbench, model approval actions, deployment release console, inference endpoint operations, monitoring operations drilldowns, alert operations workflows, and drift operations workflows.

...
- Production hardening with secure response headers, configurable API rate limiting, Prometheus metrics for throttling, production-readiness CI checks, checked OpenAPI, API authorization, and permission catalog contracts, frontend production dependency auditing, frontend bundle budgets, runbooks, threat model, backup and restore scripts, and k6 smoke load tests.

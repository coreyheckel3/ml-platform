...
- React/Vite frontend shell with SaaS-style navigation, core pages, registry promotion workbench, model approval actions, deployment release console, and inference endpoint operations.

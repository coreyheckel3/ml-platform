...
| 75 | Evaluation and Model Comparison UX | Completed: project-scoped evaluation comparison API, `/evaluation` route, run leaderboard, metric slices, model card evidence, approval checklist, reviewer narrative, RBAC, docs, release evidence, and CI contract. |
